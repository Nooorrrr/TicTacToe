...
function end(num1,num2,num3){
    ...
    document.getElementById('item'+num1).style.background = 'rgb(71,7,117)';
    document.getElementById('item'+num2).style.background = 'rgb(71,7,117)';
    document.getElementById('item'+num3).style.background = 'rgb(71,7,117)';

    setInterval(function(){title.innerHTML='New game in '},1000);
